...
class TransactionServiceTest {
    ...
    void findAllTransactionsTest() {
        ...
        List<Transaction> getAllTransactions = List.of(
                new Transaction("1",  localDate, 52.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId),
                new Transaction("2",  localDate, 32.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId));
        //WHEN
    ...
    void findTransactionByIdTest() {
        //GIVEN
        Transaction transaction = new Transaction("3",  localDate, 52.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId);
        ...
        //THEN
        Transaction expected = new Transaction("3",  localDate, 52.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId);
    ...
    void saveNewTransactionTest() {
        //GIVEN
        //WHEN
        TransactionDto transactionDto = new TransactionDto( localDate, 12.5, Account.WALLET, "Cinema", Category.ENTERTAINMENT, TransactionType.EXPENSE,appUserId);
    ...
    void updateTransactionTest() {
        ...
        String id = "4";
        TransactionDto transactionDto = new TransactionDto( localDate, 12.5, Account.WALLET, "Cinema", Category.ENTERTAINMENT, TransactionType.EXPENSE, appUserId);
        Transaction transaction = new Transaction(id,localDate, 12.5, Account.WALLET, "Cinema", Category.ENTERTAINMENT, TransactionType.EXPENSE, appUserId);
    ...
    void getTransactionsByMonthTest() {
        ...
        Transaction transaction1 = new Transaction("1",  LocalDate.parse("2024-09-01"), 52.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId);
        Transaction transaction2 = new Transaction("2",  LocalDate.parse("2024-09-05"), 75.0, Account.BANK, "Zara", Category.CLOTHES, TransactionType.EXPENSE, appUserId);
        ...
        List<TransactionDto> expected = List.of(
                new TransactionDto( LocalDate.parse("2024-09-01"), 52.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId),
                new TransactionDto( LocalDate.parse("2024-09-05"), 75.0, Account.BANK, "Zara", Category.CLOTHES, TransactionType.EXPENSE, appUserId)
        );
    ...
    void findTransactionsByTypeTest() {
        // GIVEN
        Transaction transaction1 = new Transaction("1",  localDate, 52.5, Account.BANK, "Aldi", Category.FOOD, TransactionType.EXPENSE, appUserId);
        Transaction transaction2 = new Transaction("2",  LocalDate.parse("2024-08-25"), 1500.0, Account.BANK, "Work", Category.OTHER, TransactionType.INCOME, appUserId);
